...
void adding_IT(){
    ...
    if(openfile == NULL){
        ...
        x_and_y_coordinates(print,14);printf("Department: ");gets(it.department);
        x_and_y_coordinates(print,16);printf("Email: ");gets(it.email);
        x_and_y_coordinates(print,18);printf("Contact Number: ");gets(it.contact_number);
...
void search_IT(){
    ...
    if(isFound == 1){
        ...
        x_and_y_coordinates(37,16);printf("Department: %s",it.department);
        x_and_y_coordinates(37,17);printf("Email: %s",it.email);
        x_and_y_coordinates(37,18);printf("Contact Number: %s",it.contact_number);
    }else{
...
void modify_IT(){
    ...
    while(fread(&it, sizeof(it),1,openfile) == 1){
        if(strcmp(id, it.id) == 0){
            ...
            x_and_y_coordinates(print,14);printf("Department: ");gets(it.department);
            x_and_y_coordinates(print,15);printf("Email: ");gets(it.email);
            x_and_y_coordinates(print,16);printf("Contact Number: ");gets(it.contact_number);
...
void delete_IT(){
    ...
    while(fread(&it, sizeof(it),1,openfile) == 1){
        if(strcmp(id, it.id) == 0){
            fwrite(&it,sizeof(it),1,temporary);
        }
    }
    fclose(openfile);
    fclose(temporary);
...
void main_window(){
    ...
    int x = 2;
    while(1){
        x_and_y_coordinates(x,8);printf("Choice 1. Add");
        x_and_y_coordinates(x,10);printf("Choice 2. Search");
        x_and_y_coordinates(x,12);printf("Choice 3. Modify Record");
        x_and_y_coordinates(x,14);printf("Choice 4. Delete Record");
